            ...
            ref.on('value', snap => {
               ...
               +' <div class="card-image waves-effect waves-block waves-light">'
                ...
                +'<div class="card-content">'
                  +'<span class="card-title activator grey-text text-darken-4" style="font-size:1.2rem;">'+prods[i].disc+'<i class="material-icons right">more_vert</i></span><p style="color: orange;">'+prods[i].price+' AED</p>'
